...
platformer.ghostPrefab=function(game,x,y,_level){
	...
	this.yOffset = game.rnd.realInRange(3.5,6);	//com més yOffset, més recorregut vertical farà
	this.xOffset = game.rnd.realInRange(40,67);	//com més xOffset, més "lent" anirà verticalment (la vel. hor. sempre és igual per a tots)
