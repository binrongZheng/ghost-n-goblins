...
platformer.tutorial = {
	...
	create:function(){
        ...
        this.hero = new platformer.playerPrefab(this.game,2700/*this.checkpoints[gameOptions.currentCheckpoint].x*/,this.checkpoints[gameOptions.currentCheckpoint].y,this,this.player_life,this.cursors,this.jump_key,this.space,this.with_cloth,this.playerHaveLife );
